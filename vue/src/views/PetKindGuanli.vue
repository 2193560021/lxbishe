...
<!--        <img :src="userImg" alt="" width="90" height="90" style="border-radius: 10px">-->
      ...
      <el-table-column prop="intro" label="品种信息" width="430" sortable/>
    ...
    <div style="margin:10px 0">
      ...
      >
        <el-form-item style="text-align: center" label-width="0">
          <img :src="form.img" width="300" class="avatar "
        ...
        <el-form :model="form" label-width="120px">
          ...
          <el-form-item label="所属种类">
            <el-input v-model="form.belong" style="width:90%"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    save(){
      if(this.form.id){
        request.put("/kind",this.form).then(res => {
          console.log(res)
          if(res.code == 0 ){
        ...
        request.post("/kind",this.form).then(res => {
          console.log(res)
          if(res.code == 0 ){
    ...
    handleDelete(id){
      console.log(id);
      request.delete("/kind/" + id).then(res => {
        if(res.code == 0 ){
